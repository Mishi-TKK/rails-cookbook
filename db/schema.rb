...
ActiveRecord::Schema[8.0].define(version: 2025_01_13_103837) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["recipe_id", "category_id"], name: "index_bookmarks_on_recipe_id_and_category_id", unique: true
